...
for i in range(10):
  ...
  #plt.savefig(out_dir+f'plot_xy_q{s1}.png')
  ...
  #ax3.legend(loc="upper right")
  #plt.savefig(out_dir+f'plot_ux_q{s1}.png')
  ...
  #ax3.legend(loc="upper right")
  #plt.savefig(out_dir+f'plot_uy_q{s1}.png')
  ...
  #ax3.legend(loc="upper right")
  #plt.savefig(out_dir+f'plot_uw_q{s1}.png')
  ...
  #ax3.legend(loc="upper right")
  #plt.savefig(out_dir+f'plot_xw_q{s1}.png')
  ...
  df.to_csv(path+args.fname+'seed_'+str(i)+'.csv')
