...
source_test = gen_source_data(1000, a, b, args.var, args.mean, sd_test_list)

# Generate data from target domain
target_train = gen_target_data(
    args.n_env, args.n * 2, a, b, args.var, args.mean, [5949]
)
target_test = gen_target_data(
    args.n_env, 1000, a, b, args.var, args.mean, [5654]
)
