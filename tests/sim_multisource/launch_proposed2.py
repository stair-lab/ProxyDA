...
SCRIPT = "/home/kt14/workbench/proxy_latent_shifts/tests/sim_multisource/test_proposed.py"
...
for par in test_set:
  for seed in [0.9]:
    ...
    run_name = f"test_proposed_{seed}_m_{mean}_{mean1}_var_{var}_{var1}_v3"
    fixs = True
    if fixs:
