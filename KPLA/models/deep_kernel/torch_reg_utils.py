...
This part of the code is copied from https://github.com/liyuan9988/DeepFeatureProxyVariable/blob/master/src/utils/pytorch_linear_reg_utils.py
...
def linear_reg_loss(target: torch.Tensor,
    ...
    nData, nDim = feature.size()
    return torch.norm((target - pred)) ** 2/nData + reg * torch.norm(weight) ** 2 #* nData
