...
def generate_multienv_data(z_indicator, seed, num_samples, partition_dict, param_dict=None):
  
  pu_0, z_size = from_Z_to_U(z_indicator)
  p_u = [pu_0, 1-pu_0]
  sample_dict = generate_data(p_u, seed, num_samples, partition_dict, param_dict=param_dict)
